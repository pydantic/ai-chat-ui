...
// local addition: Dialog for error display (upstream uses inline text only)
...
export type ToolHeaderProps = {
  title?: string
  icon?: ReactNode // local addition — not in upstream ai-elements
  className?: string
} & (
...
// local modification: restored Dialog-based error display from PR #11,
// and gated output rendering on !errorText to avoid showing both
      ...
      {errorText && (
        <Dialog>
          <DialogTrigger asChild>
            <button
              type="button"
              className="inline-flex items-center gap-1.5 rounded-md bg-destructive px-3 py-1.5 text-sm text-destructive-foreground hover:bg-destructive/90"
            >
